...
def test3d_8n():
    ...
    exp_idx = np.array([[7, 8, 6, 9, 5, 10, 4, 11], [93, 94, 92, 95, 91, 96, 90, 97], [45, 46, 44, 47, 43, 48, 42, 49]])
...
def test3d_8n_ub():
    ...
    exp_dist = np.array(
        [
            [0.00000000e00, 4.05250235e03, 4.07389794e03, 8.08201128e03, 8.17063009e03, np.Inf, np.Inf, np.Inf],
            [
                1.73205081e00,
                2.70216896e03,
                2.71431274e03,
            ...
            [1.41424892e02, 3.25500021e03, 3.44284958e03, 6.58019346e03, 6.81038455e03, 9.89140135e03, np.Inf, np.Inf],
        ]
    )
    n = 100
