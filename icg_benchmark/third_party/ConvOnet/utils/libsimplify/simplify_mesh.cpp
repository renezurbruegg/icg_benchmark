...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh",
        "sources": [
            "src/vgn/ConvONets/utils/libsimplify/simplify_mesh.pyx"
        ]
    },
    "module_name": "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh"
}
END: Cython Metadata */
...
/* Module declarations from 'src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh' */
...
#define __Pyx_MODULE_NAME "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh"
...
/* Implementation of 'src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh' */
 ...
 */
  ...
  __Pyx_AddTraceback("src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh.mesh_simplify", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh._memoryviewslice", /*tp_name*/
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh")) {
      if (unlikely(PyDict_SetItemString(modules, "src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.icg_benchmark.third_party.ConvOnet.utils.libsimplify.simplify_mesh");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
