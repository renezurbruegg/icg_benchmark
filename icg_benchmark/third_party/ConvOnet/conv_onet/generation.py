...
import trimesh
from icg_benchmark.third_party.ConvOnet.common import make_3d_grid, normalize_coord, add_key, coord2index
try:
    from icg_benchmark.third_party.ConvOnet.utils import libmcubes
    from icg_benchmark.third_party.ConvOnet.utils.libsimplify import simplify_mesh
    from icg_benchmark.third_party.ConvOnet.utils.libmise import MISE
except:
    ...
    def refine_mesh(self, mesh, occ_hat, c=None):
        ...
        for it_r in trange(self.refinement_step):
            ...
            face_value = torch.sigmoid(
                self.model.decode_occ(face_point.unsqueeze(0), c).logits
            )
