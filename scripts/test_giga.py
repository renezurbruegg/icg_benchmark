...
from icg_benchmark.grasping.planners import GigaPlanner
...
def main(args):
    ...
    def create_tsdf_observer(**kwargs):
        return GigaTSDFObservation(tsdf_highres=args.resolution, **kwargs)
